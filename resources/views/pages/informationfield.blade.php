                       ...
                       <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row form-group">
                          ...
                          <div class="row form-group">
                             ...
                             <div class="col-12 col-md-9"><input type="text" id="" name="height" placeholder="" class="form-control"><small class="help-block form-text">Ex. 5'3 -> 5.3</small></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="weight" class=" form-control-label">Weight</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="" name="weight" placeholder="" class="form-control"><small class="help-block form-text">Decimal Format</small></div>
                          </div>
                          <div class="row form-group">
